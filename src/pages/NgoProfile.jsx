...
return (
    <div>
      ...
      <FormContainer>
        <Sidebar>
          <ProfileImage src="https://img.freepik.com/premium-photo/cute-kawaii-cat-clipart-white-background_804788-5612.jpg" alt="Profile" />
          <SidebarSection>
          ...
          <SidebarSection>
            <a href="#volunteer" onClick={() => handleSectionChange('volunteer')}>
              Volunteers
            </a>
          </SidebarSection>
          <SidebarSection>
        ...
        <FormSection>
          {currentSection === 'dashboard' && (
            <div>
              <FormTitle id="dashboard">NGO Dashboard</FormTitle>
              <Dashboard />
            </div>
          )}
          ...
          {currentSection === 'volunteer' && (
            <div>
              <FormTitle id="volunteer">Volunteer Requests</FormTitle>
              <Volunteer />
            </div>
          )}
          ...
          {currentSection === 'basic-details' && (
            <div>
              <FormTitle id="basic-details">NGO - Basic Details</FormTitle>
              <form>
              <FormGroup>
          ...
          {currentSection === 'timings' && (
            <div>
              ...
              <form>
              <FormGroup>
              <Button type="submit">Edit Timmings</Button>
              </FormGroup>
              <FormGroup>
          ...
          {currentSection === 'images' && (
            <div>
              <FormTitle id="images">NGO Events</FormTitle>
